...
public class MovingRotorTest {
    ...
    public void checkRotorAtA() {
        ...
        setRotor("V", NAVALA, "");
        checkRotor("Rotor V (A)", UPPER_STRING, NAVALA_MAP.get("V"));
    }
    ...
    public void checkRotorAdvance() {
        ...
        setRotor("III", NAVALA, "");
        rotor.advance();
        checkRotor("Rotor III advanced", UPPER_STRING, NAVALB_MAP.get("III"));

        setRotor("IV", NAVALA, "");
        rotor.advance();
        checkRotor("Rotor IV advanced", UPPER_STRING, NAVALB_MAP.get("IV"));
    }
    ...
    public void checkRotorSet() {
        ...
        setRotor("IV", NAVALA, "");
        rotor.set(25);
        checkRotor("Rotor IV set", UPPER_STRING, NAVALZ_MAP.get("IV"));

        setRotor("V", NAVALA, "");
        rotor.set(25);
        checkRotor("Rotor V set", UPPER_STRING, NAVALZ_MAP.get("V"));
    }
